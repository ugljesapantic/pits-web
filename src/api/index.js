  ...
  clipboard: {
    ...
    updateItem: (id, itemId, body) =>
      http
        ...
        .then(res => res.data),
    addItem: (id, title) =>
      http.post(`/clipboards/${id}/items`, { title }).then(res => res.data),
    removeItem: (id, itemId) =>
      http.delete(`/clipboards/${id}/items/${itemId}`).then(res => res.data)
  },
  shoppingList: {
    ...
    updateItem: (id, itemId, body) =>
      http
        ...
        .then(res => res.data),
    addItem: (id, title) =>
      http.post(`/shopping-lists/${id}/items`, { title }).then(res => res.data),
    removeItem: (id, itemId) =>
      http.delete(`/shopping-lists/${id}/items/${itemId}`).then(res => res.data)
  },
  dairy: {
